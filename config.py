...
TSL_ACTIVATE_FRAC_OF_TP = 0.70  # OPTIMIZED: Bei 70% des TP aktivieren (ca. +0.35% bei TP=0.5%)
TSL_DISTANCE_FRAC_OF_SL_GAP = 0.40  # OPTIMIZED: 40% der SL-Range als Distanz (ca. -0.4% bei SL=-1.0%)
